import { bigint, boolean, date, decimal, index, integer, json, jsonb, pgSchema, pgTable, primaryKey, text, timestamp, uuid, } from "drizzle-orm/pg-core";
...
export const organizations = nextAuthSchema.table("organizations", {
...
export const users = nextAuthSchema.table("users", {
    id: uuid("id").defaultRandom().primaryKey(),
    name: text("name"),
...
export const accounts = nextAuthSchema.table("accounts", {
    id: uuid("id").defaultRandom().primaryKey(),
    userId: uuid("userId")
        .notNull()
...
export const verificationTokens = nextAuthSchema.table("verification_tokens", {
...
export const lessonPlans = pgTable("lesson_plans", {
    ...
    materials: json("materials").$type().notNull(),
    ...
    createdAt: timestamp("created_at").defaultNow().notNull(),
    updatedAt: timestamp("updated_at").defaultNow().notNull(),
    procedure: jsonb("procedure").$type().notNull().default({})
}, (table) => {
    return [
...
export const calendarEvents = pgTable("calendar_events", {
    ...
    reminders: json("reminders").default([]).$type(), // Array of reminder settings
    createdAt: timestamp("created_at").notNull().defaultNow(),
    updatedAt: timestamp("updated_at").notNull().defaultNow(),
});
